...
const std::optional<SortDirection>& WorkoutQuery::orderByCreatedTimeDirection() const
{
    return m_orderByCreatedTimeDirection;
}
const std::optional<SortDirection>& WorkoutQuery::orderByStartedTimeDirection() const
{
    return m_orderByStartedTimeDirection;
}
const std::optional<SortDirection>& WorkoutQuery::orderByPlannedTimeDirection() const
{
    return m_orderByPlannedTimeDirection;
}
