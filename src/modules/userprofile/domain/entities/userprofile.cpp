...
void UserProfile::setExperienceLevel(ExperienceLevel experienceLevel)
{
...
void UserProfile::setBodyweightKg(std::optional<double> bodyweightKg)
{
    m_bodyweightKg = bodyweightKg;
}
...
UserProfile UserProfile::createDefault() { return UserProfile {}; }
